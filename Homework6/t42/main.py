...
#  
# кодирование в двух символах для смешанного текста, как в википедии(где 1 и 2 повторение не кодируется, а остается нетронутым),непонятно как расшифровать. 
# Как понять декодеру: в строке-шифре "AA" - ключ к обращению списка числа повторений, или же пропускаемая часть из 2 повторений? 
